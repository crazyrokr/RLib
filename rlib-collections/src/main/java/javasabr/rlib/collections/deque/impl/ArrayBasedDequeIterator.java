...
public class ArrayBasedDequeIterator<E> implements Iterator<E> {

  final AbstractArrayBasedDeque<E> deque;
  int iterated;

  public ArrayBasedDequeIterator(AbstractArrayBasedDeque<E> deque) {
    this.deque = deque;
  }
